...
#define HanL_hOpen 137  //องศาอ้ามือจับเพื่อให้กระป๋องหลุดมือ
#define HanL_Close 150  //องศาหยิบกระป๋อง   **ห้ามให้ปลายมือแตะกัน
/*---------------------------------- มือขวา ---------------------------------*/
#define HanR_Open 123   //องศาอ้ามือจับ
#define HanR_hOpen 144  //องศาอ้ามือจับเพื่อให้กระป๋องหลุดมือ
#define HanR_Close 158  //องศาหยิบกระป๋อง   **ห้ามให้ปลายมือแตะกัน
/*---------------------------------- แขนซ้าย ---------------------------------*/
#define ArmL_F 37    //องศาเอาแขนไปด้านหน้า เพื่อแลกเปลี่ยนกระป๋อง
...
/*---------------------------------- แขนขวา ---------------------------------*/
#define ArmR_F 32   //องศาเอาแขนไปด้านหน้า เพื่อแลกเปลี่ยนกระป๋อง
